...
def obtain_retrain_args():
    ...
    parser.add_argument('--batch-size', type=int, default=64, metavar='N', help='input batch size for training (default: auto)')
...
def obtain_predict_args():
    ...
    parser.add_argument('--stride', type=int, default=512, help='predict')
    ...
    parser.add_argument('--nas', type=str, default='train', choices=['search', 'train'])
    parser.add_argument('--workers', type=int, default=0, metavar='N', help='dataloader threads')
    parser.add_argument('--resume', type=str, default='/media/dell/DATA/wy/LightRS/run/GID-Vege3/PIDNet/model_best.pth.tar', help='put the path to resuming file if needed')
