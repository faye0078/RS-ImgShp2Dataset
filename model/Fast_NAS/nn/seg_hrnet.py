...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.out_sizes = [256,48,48,48,96,192,384]
    ...
    def forward(self, x):
        ...
        feature.append(y_list[0])
        feature.append(y_list[1])
        feature.append(y_list[2])
        feature.append(y_list[3])
...
def get_seg_model(pretrained=False):
    ...
    if pretrained:
        ...
        model_paths = '/media/data/wy/model/pretrained_hrnet_encoder.pth'
