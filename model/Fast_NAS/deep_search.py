...
from engine.trainer import deep_train_task0, train_task0, train_segmenter
...
from utils.deep_search_default_args import *
...
def main():
    ...
    model_paths = "../model/pretrained_hrnet_encoder.pth"
