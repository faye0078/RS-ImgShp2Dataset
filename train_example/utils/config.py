...
def obtain_predict_args():
    ...
    parser.add_argument('--resume', type=str, default='F:/WHU_WY/LightRS/run/Guangdong_train/fast-nas/model_best.pth.tar', help='put the path to resuming file if needed')
