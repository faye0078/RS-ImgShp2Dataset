...
def obtain_retrain_autodeeplab_args():
    ...
    parser.add_argument('--network_path', default='/media/data/wy/autodeeplab-new_master/run/cityscapes/September13_12layers/network_path.npy', type=str)
    parser.add_argument('--network_arch',default='/media/data/wy/autodeeplab-new_master/run/cityscapes/September13_12layers/network_path_space.npy',type=str)
    parser.add_argument('--cell_arch', default='/media/data/wy/autodeeplab-new_master/run/cityscapes/September13_12layers/genotype.npy', type=str)
