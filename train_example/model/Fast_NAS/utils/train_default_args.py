...
NUM_CLASSES = [5, 5]
NUM_WORKERS = 1
N_TASK0 = 700  # store in-memory these many samples for the first task
TRAIN_DIR = "../data/512/"
TRAIN_LIST = "./data/lists/rs_train.lst"
# TRAIN_LIST = "./data/lists/train+.lst"
VAL_BATCH_SIZE = 14
VAL_CROP_SIZE = 256
VAL_DIR = "../data/512/"
VAL_LIST = "./data/lists/rs_val.lst"  # meta-train and meta-val learning
# VAL_LIST = "./data/lists/train+.lst"
VAL_OMIT_CLASSES = [0]  # ignore background when computing the reward
VAL_RESIZE_SIDE = 400

TEST_DIR = "../data/512/"
TEST_LIST = "./data/lists/rs_test.lst"
