...
def obtain_retrain_args():
    ...
    parser.add_argument('--model_name', type=str, default='hrnet', choices=['hrnet', 'flexinet', 'fast-nas'], help='the model name')
    ...
    parser.add_argument('--checkname', type=str, default='hrnet', help='set the checkpoint name')
