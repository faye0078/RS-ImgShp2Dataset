    ...
    for dir, _, file_list in os.walk(label1_path):
        for file in file_list:
            if file.endswith(".tif"):
                ...
                if is_exist_zero_pixel_1(np.array(gdal.Open(label1_full_path).ReadAsArray()), 0):
...
fliter_data("/media/dell/DATA/wy/data/guiyang/数据集/v2/分类/剑河/image/", 
            "/media/dell/DATA/wy/data/guiyang/数据集/v2/分类/剑河/label1/", 
            "/media/dell/DATA/wy/data/guiyang/数据集/v2/分类/剑河/label2/",
            "/media/dell/DATA/wy/data/guiyang/数据集/v2/分类/剑河/label3/",
            "/media/dell/DATA/wy/data/guiyang/数据集/v2/分类/剑河/sar/")